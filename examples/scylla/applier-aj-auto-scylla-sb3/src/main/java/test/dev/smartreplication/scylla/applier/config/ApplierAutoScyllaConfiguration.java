...
public class ApplierAutoScyllaConfiguration {
    ...
    public SmartReplicationChangeApplierManager changeApplierManager(
        ...
        ChangeApplierKafkaConfiguration kafkaConfiguration = new ChangeApplierKafkaConfiguration(
                consumerConfig, conf.getConsumerConcurrency());
        ChangeApplierEndpointConfiguration changeApplierEndpointConfiguration = new ChangeApplierEndpointConfiguration(
                conf.getServiceCode(),
                conf.getEndpoint(),
        ...
        return new SmartReplicationChangeApplierManager(
            ...
            configurationManager,
                changeApplierEndpointConfiguration,
