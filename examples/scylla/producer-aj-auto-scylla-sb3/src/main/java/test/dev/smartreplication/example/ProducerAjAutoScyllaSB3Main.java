...
public class ProducerAjAutoScyllaSB3Main {

    public static void main(String[] args) throws InterruptedException {
        log.info("Main start");
        final ConfigurableApplicationContext context = SpringApplication.run(ProducerAjAutoScyllaSB3Main.class);
